            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="left flex-item">
                    ...
                    <div v-if="task_info.taskFile" id="filedownload">
                        <a href="javascript:void(0);" v-on:click="download()" style="text-decoration: none; color: #blue"
...
export default {
    ...
    methods: {
        ...
        getProfileImageMy: function() {
            ...
            // console.log(JSON.parse(JSON.stringify(this.task_info.userEmail)));
            if (this.task_info.userEmail == null) return;
            http.get(`/viewimage/${this.task_info.userEmail}`)
                .then((response) => {
        ...
        download() {
            ...
            axios
                ...
                .then(({ data }) => {
                    ...
                    const url = window.URL.createObjectURL(new Blob([data], { type: this.task_info.taskFileType }));
