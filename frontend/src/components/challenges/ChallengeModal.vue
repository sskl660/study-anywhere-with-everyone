              ...
              <div class="d-flex">
                ...
                <div class="d-flex justify-content-start">
                  <div class="star-rating space-x-4 mx-auto">
                    <input type="radio" id="5-stars" name="rating" value="5" v-model="challengeInfo.challengeLevel" @click="dataCheck()"/>
                    <label for="5-stars" class="star pr-4 star-rating-label">★</label>
                    <input type="radio" id="4-stars" name="rating" value="4" v-model="challengeInfo.challengeLevel" @click="dataCheck()"/>
                    <label for="4-stars" class="star star-rating-label">★</label>
                    <input type="radio" id="3-stars" name="rating" value="3" v-model="challengeInfo.challengeLevel" @click="dataCheck()"/>
                    <label for="3-stars" class="star star-rating-label">★</label>
                    <input type="radio" id="2-stars" name="rating" value="2" v-model="challengeInfo.challengeLevel" @click="dataCheck()"/>
                    <label for="2-stars" class="star star-rating-label">★</label>
                    <input type="radio" id="1-star" name="rating" value="1" v-model="challengeInfo.challengeLevel" @click="dataCheck()"/>
    ...
    submit: function () {
      ...
      if (this.isEmpty) {
        ...
        if (!this.isOkay) {
          ...
          this.$router.push({ name: 'ChallengeRoom'})
        }
      }
    },
